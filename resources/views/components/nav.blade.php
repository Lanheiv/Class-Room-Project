<div class="w-full bg-gray-100 dark:bg-zinc-900 shadow-md">
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-gray-100 dark:bg-zinc-900 px-4 pt-4 pb-2 space-y-2">
        <a href="{{ url('/join-class') }}" class="block px-4 py-2 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 transition">Join Class</a>
        <a href="{{ url('/') }}" class="block px-4 py-2 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 transition">Classes</a>
        @if(auth()->user()->role == "teacher")
            <a href="{{ url('/create-class') }}" class="block px-4 py-2 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 transition">Make class</a>
        @endif
        @if(auth()->user()->role == "admin")
            <a href="/admin" class="block px-4 py-2 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 transition">Admin panel</a>
        @endif
        <a href="{{ url('/profile') }}" class="block px-4 py-2 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 transition">Profile</a>
    </div>
</div>
