                    ...
                    <tbody>
                        @foreach($users as $user)
                            <tr class="border-b border-gray-100 dark:border-zinc-700">
                                ...
                                <td class="text-gray-600 dark:text-zinc-300 break-all">
                                    {{ $user->email }}
                                </td>
            ...
            <div class="space-y-3 max-h-[260px] sm:max-h-[420px] overflow-y-auto">
                @foreach($logs as $log)
                    <div class="p-3 rounded-xl bg-gray-100 dark:bg-zinc-900">
                        <p class="text-sm text-gray-800 dark:text-zinc-100">
                            {{ $log->action }}
                        </p>
                        <p class="text-xs text-gray-500 dark:text-zinc-400 break-all">
